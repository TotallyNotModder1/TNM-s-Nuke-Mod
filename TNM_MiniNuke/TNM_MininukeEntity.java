...
public class TNM_MininukeEntity extends Entity {
	public int ticksinair;

	public TNM_MininukeEntity(World var1) {
		super(var1);
		this.ticksinair = 0;
	...
	public TNM_MininukeEntity(World var1, double var2, double var4, double var6) {
		this(var1);
